...
import estruturasADT.StackADT;
import exceptions.EmptyCollectionException;

/**
 * SmackStackADT represents a stack implemented using an array with dynamic capacity adjustment.
 *
 * @param <T> the type of elements stored in the stack
 */
public class SmackStackADT<T> implements StackADT<T> {
     ...
     */
    public SmackStackADT(int initialCapacity) {
        top = 0;
    ...
    /**
     * Removes the last element of the stack and decreases the capacity.
     * Throws an EmptyCollectionException if the stack is empty.
     *
     * @return T element removed from the last position of the stack
     * @throws EmptyCollectionException if a popLast is attempted on an empty stack
     */
    public T popLast() throws EmptyCollectionException {
        if (isEmpty())
            throw new EmptyCollectionException("Stack");
        T result = stack[0];
        stack[0] = null;
    ...
    /**
     * Decreases the capacity of the stack array by removing the first element.
     */
    public void decreaseCapacity() {
        T[] temp = (T[]) (new Object[top]);
        System.arraycopy(stack, 1, temp, 0, top - 1);
        top--;
        stack = temp;
    }
